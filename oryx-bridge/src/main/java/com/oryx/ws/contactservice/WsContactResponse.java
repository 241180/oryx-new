 ...
 *         &lt;element name="conact" type="{http://model.ref.ws.oryx.com}XmlContact" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "wsContactResponse")
public class WsContactResponse {

    @XmlElement(required = true)
    protected String request;
    @XmlElement(required = true)
    protected List<XmlContact> conact;
     ...
     * 
     */
    public List<XmlContact> getConact() {
        if (conact == null) {
            conact = new ArrayList<XmlContact>();
        }
        return this.conact;
    }
