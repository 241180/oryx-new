...
/**
 * <p>Classe Java pour TracableCancelableEntityVO complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="TracableCancelableEntityVO">
 *   &lt;complexContent>
 *     &lt;extension base="{http://model.ref.ws.oryx.com}CancelableEntityVO">
 *       &lt;sequence>
...
@XmlType(name = "TracableCancelableEntityVO", propOrder = {
    "createDate",
    "createdBy",
    "updateDate",
    "updatedBy"
...
@XmlSeeAlso({
    ...
    ParameterVO.class,
    AnnexVO.class,
    FieldProcessParamVO.class,
    PersonVO.class,
    RoleInfoVO.class,
    StateVO.class,
    ThirdPartyVO.class,
    ErrorMessageVO.class,
    MenuVO.class,
    DomainVO.class,
    UidVO.class,
    TranslationVO.class,
    TaskVO.class,
    CountryVO.class,
    CodificationVO.class
})
public class TracableCancelableEntityVO
    extends CancelableEntityVO
{
