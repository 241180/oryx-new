...
<div class="row-fluid">
    <div class="span4 offset4 well" ng-controller="loginController">
        ...
        <form method="post" action="j_spring_security_check">
            <div>
                <input name="username" id="j_username" type="text" class="span12" placeholder="<spring:message code='sample.email' /> "><br/>
                <input name="password" id="j_password" type="password"  class="span12" placeholder="Password"><br/>
